...
def find_extra_copies(target_fasta, reference_fasta, processes, word_size, final_feature_list, gene_db, old_chroms, full_db_name, new_chroms):
    ...
    all_extra_copies = lg.extact_and_align_genes(target_fasta, reference_fasta, old_chroms, ['all'], processes, word_size,
                                                 gene_db, "copies", False, new_chroms)
