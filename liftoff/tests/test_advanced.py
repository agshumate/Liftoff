...
def test_yeast(tmp_path):
    ...
    # outputs
    output = str(
        tmp_path / 'GCA_000146045.2_R64_to_GCA_000146045.2_advanced.gff3')
    unmapped = str(
        tmp_path / 'unmapped_features_GCA_000146045.2_R64_advanced.txt')
    ...
    # run the program
    args = ['-g', annot, '-o', output, '-u', unmapped, '-dir', tempdir,
            '-chroms', chroms, '-unplaced', unplaced, '-copies',  target, asmbl]
