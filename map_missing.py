...
def map_unmapped_genes_agaisnt_all(unmapped_genes, target_fasta, reference_fasta, processes, word_size, final_feature_list, gene_db, full_db_name):
    ...
    missing_lifted, unmapped_genes = lg.lift_all_genes(processes, "missing_db", all_missing_records, {}, 0.0, None)
    ...
    final_features_with_missing = resolve_overlapping_homologues(all_missing_records, final_feature_list, remap_genes, unmapped_genes, full_db_name, processes, 0.0, None)
